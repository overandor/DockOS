      ...
      <div className="w-full max-w-md">
        <div className="neo-card rounded-2xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-textMuted">Create your DockOS account</p>
          </div>
          ...
          <div className="mt-6 relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-card text-textMuted">Or sign up with</span>
            </div>
          </div>
        ...
        <p className="text-center text-textMuted text-sm mt-6">
          ...
          <Link href="/auth/login" className="text-primary hover:text-primaryLight font-semibold">
            Sign in
          </Link>
        </p>
      </div>
